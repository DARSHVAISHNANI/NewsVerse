...
Latest_Article_Searcher = Agent(
    ...
    instructions=[
        "Use Crawl4Aitools to search for the latest trending news articles.",
...
agent_team.print_response(
    ...
    "make sure that the url is working properly or other wise the URL_Extractor url must be paste which is accessable to user."
